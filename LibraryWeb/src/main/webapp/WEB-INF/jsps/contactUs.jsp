...
<link href="<c:url value = '/resources/css/main.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value = '/resources/css/contact_us.css'/>"
		...
		<table class="side_bar">
			<tr>
					...
					<div class="contact_form">
						<fieldset>
							...
							<script type="text/javascript"
								src="http://form.jotform.co/jsform/31074051352846"></script>
				...
				<td><table class="images">
						<tr>
							<td><img src="<c:url value='/resources/img/capture.png'/>"
								height="80" width="185"></td>
						</tr>
						<tr>
							<td><p>
									<strong>Call on 1800 123 89</strong>
								</p></td>
						</tr>
						<tr>
							<td><img src="<c:url value='/resources/img/facebook.gif'/>"
								height="80" width="185"></td>
						</tr>
						<tr>
							<td><img src="<c:url value='/resources/img/twitter.jpg'/>"
								height="80" width="185"></td>
						</tr>
					</table></td>
			</tr>
